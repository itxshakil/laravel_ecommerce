...
<div class="container mx-auto flex justify-center px-6 my-12">
    ...
    <a class="pt-4 text-blue-500 float-right text-sm" href="{{route('products.index')}}">All Products</a>
        ...
        <form class="px-8 pt-6 pb-2 mb-4 bg-white rounded" method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
            <div class="mb-4">
                ...
                <input
                    ...
                    id="name" type="text" required placeholder="New Product" name="name" value="{{ old('name') }}" required
